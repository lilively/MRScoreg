...
dicompath = "C:\Users\lilif\OneDrive\Desktop\Dropbox\Phd\mv_data\pseudoprogression_lt\Cases_UAB\Case87-1\XX_0006";
nii_file = "C:\Users\lilif\OneDrive\Documents\MATLAB\Output\Case87-1.nii";
outF = "C:\Users\lilif\OneDrive\Documents\MATLAB\Output";

dicominfo(dicompath)

% createMask (dicompath,nii_file,outF)
disp('caca')
function createMask (dicompath,nii_file,outF)
    disp('clicled')
    [fPath, fName, fExt] = fileparts(dicompath);
    ...
    nii_outname = fullfile(outF,strcat(fName, '-mask.nii'))
    nii_outname = convertStringsToChars(nii_outname);
    
    % V_mask.fname='C:\Users\Lili\Dropbox\Phd\3.FIS-MRS-ML\Images\ITKsnap\220317-1-mask.nii';
    V_mask.fname= nii_outname;
    %[MRIFOVMask_file]; %%%
    ...
    fprintf('Mask saved to: %s', nii_outname)
end